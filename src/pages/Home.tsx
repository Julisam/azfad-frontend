      ...
      <section className="bg-linear-to-br from-blue-900 to-purple-900 text-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex gap-4 justify-center">
            <Link to="/courses" className="bg-white text-blue-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">
              Browse Courses
            </Link>
            <Link to="/about" className="border border-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-900 transition">
              Learn More
            </Link>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition">
                ...
                <Link to="/courses" className="text-blue-600 font-semibold flex items-center hover:text-blue-800">
